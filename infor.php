...
<button class="irpara_a"><a href="categ.php" target="_self" class="ligacao">IR PARA A MATRÍCULA</a></button>
  <button class="irpara_b"><a href="index.php" target="_self" class="ligacao">VOLTAR</a></button>
</div>
